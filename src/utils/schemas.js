...
export const WEEKLY_SUMMARY_SCHEMA = {
  ...
  required: ['summary', 'highlight', 'insight', 'suggestion'],
}

export const LIVE_FRAME_SCHEMA = {
  type: 'object',
  properties: {
    exercise: { type: 'string' },
    form_score: { type: 'number' },
    rep_delta: { type: 'number' },
    tip: { type: 'string' },
    body_position: { type: 'string' },
  },
  required: ['exercise', 'form_score', 'rep_delta', 'tip', 'body_position'],
}
