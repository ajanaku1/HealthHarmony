      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4 bg-gray-50">
            ...
            <div className="flex flex-wrap justify-center gap-2">
              {SUGGESTIONS.map((s) => (
                <button
                  ...
                  className="text-xs bg-white border border-gray-200 rounded-full px-4 py-2 text-gray-600 hover:bg-emerald-50 hover:border-emerald-200 hover:text-emerald-700 transition-colors"
                >
                  {s}
                </button>
              ))}
        ...
        {activeToolCall && (
          <div className="flex justify-start">
            <div className="rounded-xl rounded-bl-sm px-4 py-2 bg-blue-50 border border-blue-100">
        ...
        {streaming && streamingText && (
          <div className="flex justify-start">
            <div className="max-w-[80%] rounded-xl rounded-bl-sm px-4 py-3 bg-white border border-gray-100 shadow-sm">
        ...
        {streaming && !streamingText && !activeToolCall && (
          <div className="flex justify-start">
            <div className="rounded-xl rounded-bl-sm px-4 py-3 bg-white border border-gray-100 shadow-sm">
        ...
        {groundingSources && groundingSources.groundingChunks && (
          <div className="flex justify-start">
            <div className="max-w-[80%] rounded-lg px-3 py-2 bg-gray-50 border border-gray-200">
      ...
      <div className="flex-shrink-0 bg-white border-t border-gray-200 px-4 py-3">
        <div className="flex items-end gap-2 max-w-4xl mx-auto">
          <textarea
            ...
            rows={1}
            className="flex-1 resize-none rounded-lg border border-gray-200 px-4 py-2.5 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:border-transparent placeholder-gray-400"
          />
          <button
            onClick={() => handleSend()}
            disabled={!input.trim() || streaming}
            className="w-10 h-10 bg-gradient-to-r from-emerald-500 to-teal-500 text-white rounded-lg flex items-center justify-center hover:from-emerald-600 hover:to-teal-600 transition-colors active:scale-[0.97] disabled:opacity-40 disabled:cursor-not-allowed flex-shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2"
          >
